...
begin
	using Plots, StatsPlots, PlutoUI, DataFrames
	TableOfContents()
end
...
# ╔═╡ c9cb4107-0765-4c5f-9be1-5056db8b3cde
md"## Plotting Functions"

# ╔═╡ 994e567f-4f00-475a-bd8e-608b72001104
begin
...
# ╔═╡ d1a06e5e-e006-4a89-8a8c-397631f2da2e
begin 
	function x4(t,r)
			(r/2)*x^2 - cos(t)
	end
	...
	function eulerImproved(func, t₀, x₀, r, h, n)
		t = t₀:h:(t₀ + n * h)
		x = zeros(length(t))
		x[1] = x₀
...
begin
	test = euler(f4, 0, x₀, r, h, 1000)
	test2 = eulerImproved(f4, 0, x₀, r, h, 1000)
